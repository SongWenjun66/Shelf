...
public class RetrofitManager {
    public static final String DYTH_BASEURL = "123";
...
//    public <T> INetService getNetService2() {
//        return new Retrofit.Builder()
//                .baseUrl(NetConfig.BASE_URL2)
//                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
//                .addConverterFactory(ScalarsConverterFactory.create())
//                .client(getClientWithoutCache())
//                .build()
...
//    }
    ...
    public OkHttpClient getClientWithoutCache() {
        return new OkHttpClient.Builder()
                //设置缓存路径,设置大小
                .cache(new Cache(new File(OverAppLocation.getOverAppLocation().context.getCacheDir(), "HttpCache"), 10 * 1024 * 1024))
                .connectTimeout(6 * 10000, TimeUnit.SECONDS)
                .readTimeout(6 * 10000, TimeUnit.SECONDS)
                .writeTimeout(6 * 10000, TimeUnit.SECONDS)
